<script>
	...
	if (editor !== null) {
		...
		for (var i = 0; i < blind_spots.length; i ++) {
			...
			bce_canvas_render.bce_canvas_render__blind_spot_canvas(blind_spot_canvas_ctx, rectangle.left, rectangle.top, blind_spot_canvas.width, blind_spot_canvas.height, $user_color_theme, blind_spot);
		    }
		}
	    }
	}
