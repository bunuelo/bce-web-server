<h1>BCE</h1>
<p>The BCE Web Server is an example web-based client application that accesses the BCE REST API.</p>
...
<input type="range" min="50" max="80" value="50" class="slider" id="ipd">
